...
class DatabaseHelper {
  ...
  String ColColor = 'background';
  String colStartTimeZone = 'startTimeZone';
  String colDescription = 'description';
  String colEndTimeZone = 'endTimeZone';
  ...
  void _createDb(Database db, int newVersion) async {
    await db.execute(
        'CREATE TABLE $tableName($colId INTEGER PRIMARY KEY AUTOINCREMENT, $colEventName TEXT, '
        '$colFrom TEXT, $colTo TEXT, $colIsAllDays INTEGER, $colDescription TEXT, $colStartTimeZone TEXT, $colEndTimeZone TEXT )');
  }
